        ...
        <div class="ha-header-perspective">
        	<div class="ha-header-front">
                ...
                if( ot_get_option('ut_use_cache' , 'off') == 'on' ) {
                    ...
                    $main_menu   = get_transient('ut_main_menu');
                    $mobile_menu = get_transient('ut_mobile_menu');
                    $cacheTime      = ot_get_option('ut_cache_ltime' , '10');
                    
                    if ($main_menu === false) {
                        
                        $main_menu = wp_nav_menu( $mainmenu );                        
                        set_transient('ut_main_menu', $main_menu, 60*$cacheTime);
                    ...
                    if ($mobile_menu === false) {
                        ...
                        set_transient('ut_mobile_menu', $mobile_menu, 60*$cacheTime);
                ...
                <?php if ( has_nav_menu( 'primary' ) ) : ?>
                	<span class="header-socials">
                        <?php 
                            ...
                            if( is_array( $social ) && !empty( $social ) ) {
                                ...
                                echo '<ul class="ut-footer-so ut-header-so">';    
                    ...
                    <span class="header-socials-mobile text-center">
                        <?php 
                            ...
                            if( is_array( $social ) && !empty( $social ) ) {
                                ...
                                echo '<ul class="ut-footer-so ut-header-so text-center">';    
